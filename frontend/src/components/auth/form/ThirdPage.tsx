...
export const ThirdPage: FC<ThirdPageProps> = ({changePage, control}) => {
    return (
        <ScrollView nestedScrollEnabled className="flex-1" style={{ width: width }}>
            <View className="gap-y-5 mx-10">
                ...
                <RadioButton control={control} name="q_experiences_1" firstLabel="Yes" secondLabel="No" />
                <TextParagraph notCentered>
                    Does your breathing change with the seasons,
                    weather, or air quality?
                </TextParagraph>
                <RadioButton control={control} name="q_experiences_2" firstLabel="Yes" secondLabel="No" />
                <TextParagraph notCentered>
                    Does breathing make it difficult to do such
                    things as carry heavy loads, run, or swim?
                </TextParagraph>
                <RadioButton control={control} name="q_experiences_3" firstLabel="Yes" secondLabel="No" />
                <TextParagraph notCentered>
                    Compared to others your age, do you tire easily?
                </TextParagraph>
                <RadioButton control={control} name="q_experiences_4" firstLabel="Yes" secondLabel="No" />
                <TextParagraph notCentered>
                    Do you currently smoke tobacco, or have you smoked
                    tobacco in the last month?
                </TextParagraph>
                <RadioButton control={control} name="q_experiences_5" firstLabel="Yes" secondLabel="No" />
                <View className="my-2"/>
